...
<div class="content-wrapper">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <g:form controller="training" action="saveTraining">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            <tr>
                                <th>Title</th>
                                <td>
                                    <g:textField name="title" value="${e.title}" style="width:500px; height:30px;"/>
                            ...
                            <tr>
                                <th>Image</th>
                                <td>
                                    <g:textField name="imagePath" style="width:500px; height:30px;"/>
                                    %{--<input type="text" name="imagePath" style="width:500px; height:30px;">--}%
                            ...
                            <tr>
                                ...
                                <td>
                                    <g:textField name="short_detail" value="${e.short_detail}" style="width:500px; height:30px;"/>
                                    %{--<input type="text" name="title" style="width:750px; height:30px;">--}%
                                </td>
                            </tr>
                            <tr>
                                <th>Description</th>
                                <td>
                                    <ckeditor:editor name="full_detail" height="400px" width="80%" id="full_detail">
                                    </ckeditor:editor>
                                </td>
                            </tr>

                        </table>
                        <input type="submit" value="SAVE" onclick="saveCkEditorContent();">
                    </g:form>
                </div>
            </div>
    ...
    <script>
        ...
        function saveCkEditorContent() {
            var value = CKEDITOR.instances['full_detail'].getData();
//            alert(value);
            var URL = "${createLink(controller:'training',action:'ckEditorData')}";
            $.ajax({
