...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <table cellpadding="10">
            <tr>
                <th>
                    <g:form controller="service" action="viewServiceDash">
                        <button class="btn btn-primary" onclick="">Service Panel</button>
                    </g:form>
                </th>
                <th>
                    <g:form controller="mainService" action="viewMainServices">
                        <button class="btn btn-danger" onclick="">Features</button>
                    </g:form>
                %{--<g:form controller="training" action="viewTrainingDash">
