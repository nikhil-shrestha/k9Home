...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <table cellpadding="10">
            <tr>
                <th>
                    <g:form controller="works" action="viewWorks">
                        <button class="btn btn-primary" onclick="">About</button>
                    </g:form>
                </th>
                <th>
                    <g:form controller="about" action="viewAboutDash">
                        <button class="btn btn-success" onclick="">Offers</button>
                    </g:form>
                </th>
                <th>
                    <g:form controller="staff" action="viewStaffs">
                        <button class="btn btn-danger" onclick="">Staffs</button>
                    </g:form>
                </th>
            </tr>
        </table>
