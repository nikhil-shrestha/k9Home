        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <g:uploadForm controller="blog" action="saveBlog">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            <tr>
                                <th>Title</th>
                                <td>
                                    <g:textArea name="title" rows="5" cols="67"/>
                                </td>
                            </tr>
                            <tr>
                                <th>Image</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <g:textField name="less_description" style="width:500px; height:30px;"/>
                                </td>
                            </tr>
                            <tr>
                                <th>Description</th>
                                <td>
                                    <ckeditor:editor name="description" height="400px" width="80%" id="myeditor">
                                    </ckeditor:editor>
                                </td>
                            </tr>
...
//            alert(value);
            var URL = "${createLink(controller:'blog',action:'ckEditorData')}";
            $.ajax({
