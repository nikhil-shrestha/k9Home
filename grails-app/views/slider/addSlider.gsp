        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <g:uploadForm controller="slider" action="saveSlider">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            <tr>
                                <th>Title</th>
                                <td>
                                    <g:textField name="img_title" style="width:500px; height:30px;"/>
                            ...
                            <tr>
                                <th>Description</th>
                                <td>
                                    <g:textArea name="img_description"  rows="4" cols="67"/>
                                </td>
                            </tr>
