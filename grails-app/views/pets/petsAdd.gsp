        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <g:uploadForm controller="pets" action="savePets">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            <tr>
                                <th>Title</th>
                                <td>
                                    <g:textField name="pet_name" style="width:500px; height:30px;"/>
                            ...
                            <tr>
                                <th>Image</th>
                                <td>
                                    <g:if test="${flash.message}"><div class="message"
                                                                       role="status">${flash.message}</div></g:if>
                                    <fieldset class="form">
                            ...
                            <tr>
                                <th>Details</th>
                                <td>
                                    <ckeditor:editor name="details" height="400px" width="80%" id="details">
                                    </ckeditor:editor>
                                </td>
                            </tr>

                        </table>
                        <button class="btn btn-primary" value="SAVE" onclick="saveCkEditorContent();">SAVE</button>
                    </g:uploadForm>
                </div>
            </div>
...
//            alert(value);
            var URL = "${createLink(controller:'pets',action:'ckEditorData')}";
            $.ajax({
